...
function setSeasonFocus(Direction){
    if(Direction == "UP"){
        ...
        actualSources = "http://dev.bbincovatio.com/vod/srs/"+currentSerie['FLDR']+"T"+seasonFocused+"/"+chapterFocused;
        showPlayingPanel();
...
function selectMovie(){
    if(List[moviePosition]['TYPE']=="Serie"){
        ...
        actualSources = "http://dev.bbincovatio.com/vod/mvs/"+List[moviePosition]['FLDR']+List[moviePosition]['FILE'];
        showPlayingPanel();
        PlayMovie(actualSources + ".mp4", 0);
    }
}
...
function selectSuggestedMovie(){
    if(currentSuggestedMovie['TYPE']=="Serie"){
        ...
        playingMovie = true;
        currentContentType = "Movie";
        actualSources = "http://dev.bbincovatio.com/vod/mvs/"+currentSuggestedMovie['FLDR']+currentSuggestedMovie['FILE'];
        showPlayingPanel();
        PlayMovie(actualSources + ".mp4", 0);
    }
}
