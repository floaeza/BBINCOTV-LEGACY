...
#Identifier = requests.post('http://bbinco.fortiddns.com:669/Core/Controllers/PY.php', data=payload)
    ...
    for change in changes:
        if change.type.name == 'ADDED':
            ...
            if stb['status'] == 'pending':
                ...
                var = requests.post('http://dev.bbincovatio.com/Core/Controllers/Firebase.php', data=payload)
