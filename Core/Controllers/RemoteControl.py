...
#Identifier = requests.post('http://bbinco.fortiddns.com:669/BBINCO/TV2/Core/Controllers/PY.php', data=payload)
    ...
    for change in changes:
        if change.type.name == 'ADDED':
            ...
            if stb['status'] == 'pending':
                ...
                var = requests.post('http://10.0.3.241/BBINCO/TV2/Core/Controllers/Firebase.php', data=payload)
