...
Devices = requests.post('http://dev.bbincovatio.com/Core/Controllers/DevicesStatus.php', data=payload)
...
for ips in IDF:
    ...
    try:
        ...
        req = requests.post('http://dev.bbincovatio.com/Core/Controllers/DevicesStatus.php', data=info)            
    except:
